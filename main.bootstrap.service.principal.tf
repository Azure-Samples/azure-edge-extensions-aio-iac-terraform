module "bootstrap_service_principal" {
  ...
  postfix                     = var.postfix
  onboard_sp_creation_enabled = var.bootstrap_service_principal_onboard_sp_creation_enabled
  aio_sp_creation_enabled     = var.bootstrap_service_principal_aio_sp_creation_enabled
